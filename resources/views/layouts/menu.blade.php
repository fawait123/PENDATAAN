<ul>
            ...
            <ul>
                ...
                <li>
                    <a href="{{ route('penghapusan.index') }}"
                        class="{{ Request::is('penghapusan*') ? 'active' : '' }}">
                        <div class="tooltip-item in-active" data-bs-toggle="tooltip" data-bs-placement="right"
                            title="" data-bs-original-title="Analytics" aria-label="Analytics"></div>
    ...
    @if (auth()->user()->role == 'Kepala Sekolah')
        <li>
            ...
            <ul>
                <li>
                    <a href="{{ route('laporan.index', 'peminjaman') }}"
                        class="{{ Request::is('laporan/peminjaman*') ? 'active' : '' }}">
                        <div class="tooltip-item in-active" data-bs-toggle="tooltip" data-bs-placement="right"
                            title="" data-bs-original-title="Analytics" aria-label="Analytics"></div>
                ...
                <li>
                    <a href="{{ route('laporan.index', 'pengembalian') }}"
                        class="{{ Request::is('laporan/pengembalian*') ? 'active' : '' }}">
                        <div class="tooltip-item in-active" data-bs-toggle="tooltip" data-bs-placement="right"
                            title="" data-bs-original-title="Analytics" aria-label="Analytics"></div>
                ...
                <li>
                    <a href="{{ route('laporan.index', 'penghapusan') }}"
                        class="{{ Request::is('laporan/penghapusan*') ? 'active' : '' }}">
                        <div class="tooltip-item in-active" data-bs-toggle="tooltip" data-bs-placement="right"
                            title="" data-bs-original-title="Analytics" aria-label="Analytics"></div>
                ...
                <li>
                    <a href="{{ route('laporan.index', 'mutasi') }}"
                        class="{{ Request::is('laporan/mutasi*') ? 'active' : '' }}">
                        <div class="tooltip-item in-active" data-bs-toggle="tooltip" data-bs-placement="right"
                            title="" data-bs-original-title="Analytics" aria-label="Analytics"></div>
