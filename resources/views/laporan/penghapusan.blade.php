...
@section('ruang.content')
    <div class="container">
        <a href="{{ route('laporan.pdf') }}?download=penghapusan" class="btn btn-primary btn-sm">DOWNLOAD <i
                        ...
                        <tbody>
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->ba ?: '(blank)' }}</td>
                                    <td>{{ $item->detail->tgl_penghapusan ?: '(blank)' }}</td>
                                    <td>{{ $item->detail->kondisi_akhir ?: '(blank)' }}</td>
