    ...
    <div class="container">
        <div class="card">
            <div class="card-header d-flex flex-row align-items-center justify-content-between">
                ...
                <a href="{{ route('peminjams.index', []) }}" class="btn btn-light"><i class="fa fa-caret-left"></i> Back</a>
            </div>
    ...
    <tr>
        ...
        <tr>
            ...
            <div class="card-footer d-flex flex-column flex-md-row align-items-center justify-content-end">
                <a href="{{ route('peminjams.edit', compact('peminjam')) }}" class="btn btn-info text-nowrap me-1"><i class="fa fa-edit"></i> @lang('Edit')</a>
                <form action="{{ route('peminjams.destroy', compact('peminjam')) }}" method="POST" class="m-0 p-0">
                    @csrf
                    @method('DELETE')
